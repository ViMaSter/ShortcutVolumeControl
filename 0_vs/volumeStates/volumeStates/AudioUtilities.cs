...
namespace volumeStates
{
    public static class AudioUtilities
    {
        ...
        public static IList<AudioDevice> GetAllDevices()
        {
            ...
            deviceEnumerator.EnumAudioEndpoints(EDataFlow.eRender, DEVICE_STATE.MASK_ALL, out collection);
            if (collection == null)
                return list;
        ...
        public static IList<AudioSession> GetAllSessions()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                ISimpleAudioVolume sav = ctl as ISimpleAudioVolume;
    ...
    public sealed class AudioSession : IDisposable
    {
        ...
        public float Volume
        {
            get
            {
                CheckDisposed();
                float level;
                int res =_sav.GetMasterVolume(out level);
                return level;
            }
            set
            {
